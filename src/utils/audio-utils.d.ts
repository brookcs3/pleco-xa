...
export function findAllZeroCrossings(audioData: Float32Array, start: number): number[];
export function findAudioStart(audioData: Float32Array, sampleRate: number): number;
