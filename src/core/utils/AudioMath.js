 ...
 * ```
 */
export function amplitudeToDb(amplitude, reference = AudioConstants.REFERENCE_AMPLITUDE) {
 ...
 * ```
 */
export function dbToAmplitude(db, reference = AudioConstants.REFERENCE_AMPLITUDE) {
...
export function frequencyToMidi(frequency) {
  ...
  return AudioConstants.MIDI_A4 + 12 * Math.log2(frequency / AudioConstants.A4_FREQUENCY);
}
...
export function midiToFrequency(midiNote) {
  return AudioConstants.A4_FREQUENCY * Math.pow(2, (midiNote - AudioConstants.MIDI_A4) / 12);
}
 ...
 * ```
 */
export function applyFade(samples, fadeInSamples, fadeOutSamples, curve = 'linear') {
 ...
 * ```
 */
export function crossfade(samplesA, samplesB, crossfadeLength, curve = 'linear') {
