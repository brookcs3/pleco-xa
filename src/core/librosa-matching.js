...
export class Matcher {
    ...
    matchIntervals(intervalsFrom, intervalsTo, strict = true) {
        ...
        try {
            ...
            console.log(`🎯 Matched ${intervalsFrom.length} intervals with ${strict ? 'strict' : 'relaxed'} matching`);
            return result;
        } catch (error) {
    ...
    matchEvents(eventsFrom, eventsTo, left = true, right = true) {
        ...
        console.log(`🎯 Matched ${fromArray.length} events with left=${left}, right=${right}`);
        return result;
    }
